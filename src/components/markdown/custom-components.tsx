...
const AnchorIconStyled = styled(Anchor)`
  display: inline-block;
  position: absolute;
  width: 0.5em;
  height: 0.5em;
...
const AnchoredLinkStyled = styled(AnchoredLink)`
  position: relative;
  ${AnchorIconStyled} {
     visibility: hidden;
  }
...
const customSatellytesComponents = {
  ...
  a(props) {
    if (props.href && props.href?.startsWith('#')) {
      return (
        <AnchoredLinkStyled {...props}>{props.children}</AnchoredLinkStyled>
      );
    }
