...
It might look like a game, but it's only the optics. Only people you invite can access your world. You pick an avatar and walk around a virtual office. Once you bump into a colleague, a small video window opens near your avatar, and you can start talking. When you walk away from a conversation, the video and voices diminish until the chat closes. When you focus a different window, while not being in a conversation, your video and audio are always muted, but people can still try to approach.
...
### All-hands meetings
Once I reached a "critical mass" of people using Gather, I decided to switch our all-hands meeting on Mondays from Zoom to Gather. We would run our meeting on a small, sunny island. That was also the first time I had to use the [mapmaker](https://support.gather.town/help/mapmaker). Because everything is possible in the Metaverse I decided to build a suburban station to connect the island with our office.

![](images/gather/gather-smm.jpg)
_Our Satellytes folks gathering for our all-hands meeting on a Monday_

The actual meeting is comparable to Zoom or Meet. We broadcast some news and people can share thoughts and ask questions. The time before and after that meeting is where the Metaverse shines ✨. 

People bump into each other, create random groups, and tell their stories from the weekend. Compare this with the Zoom dystopia, where everyone usually joins into a single room and leave directly after the meeting back into isolation (I exaggerated a little) 
...
_Official Gather video from [gather.town](http://www.gather.town)_
